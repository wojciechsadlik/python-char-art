...
from ascii_palettes import ascii_palette, ascii_palette_v2


def img2ascii_arr(img: Image.Image, dither=DITHER_MODES.NONE,
                  scale_vertically=True, palette: list[str] = ascii_palette) -> list[list[str]]:
    if scale_vertically:
...
def img2ascii_arr_v2(img: Image.Image, palette: list[list[str]] = ascii_palette_v2, dither=DITHER_MODES.NONE) -> list[list[str]]:
